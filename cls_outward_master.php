...
public function pageSearch()
{
    ...
    $select_columns = "t.outward_no,t.outward_date,t4.customer_name AS customer_name,t5.city_name AS city_name,t9.variety,t8.inward_no,t8.inward_date,t9.lot_no,t1.out_qty,t12.packing_unit_name AS packing_unit,t1.out_wt,t1.loading_charges,t.outward_order_by,t.delivery_to,t.vehicle_no,t.driver_name,t.transporter,
   ...
   $sql = "CALL " . $database_name . "_search_detail('" . $select_columns . "', '" . $from_clause . "', '" . $where_condition . "')";
    ...
    <table id="searchMaster" class="ui celled table display">
        <thead>
            <tr>
                ...
                <th>Variety<br><input type="text" data-index="14" placeholder="Search Inward Date" /></th>
    ...
    foreach ($_dbh->query($sql) as $_rs) {
        ...
        $_grid .= "<tr>
            ...
            <td>" . (isset($_rs["outward_date"]) ? date("d/m/Y", strtotime($_rs["outward_date"])) . "<br><small>" . date("h:i:s a", strtotime($_rs["outward_date"])) . "</small>" : "") . "</td>
